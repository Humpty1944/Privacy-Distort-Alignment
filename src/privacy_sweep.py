"""
Automatically runs DP Full SFT across the epsilon grid:
epsilons = [float("inf"), 8, 4, 2, 1, 0.5]
"""
...
DEFAULT_EPSILONS: Sequence[float] = (float("inf"), 8, 4, 2, 1, 0.5)
...
def run_privacy_sweep(
    ...
    for target_epsilon in epsilons:
        eps_label = "inf" if target_epsilon == float("inf") else target_epsilon
        print(f"\n===== Privacy sweep: target epsilon = {eps_label} =====")
